...
\textbf{Previous Quantum Data Structures:} Several quantum Bloom filter proposals exist~\cite{yan2015,zeng2015}, typically using Grover search requiring $\sqrt{N}$ depth per query. Our work differs by: (1) unified framework, (2) practical NISQ implementation, (3) honest limitation assessment, (4) comprehensive validation.
